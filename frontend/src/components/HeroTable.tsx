...
function HeroTable({isAdmin}: {isAdmin: boolean}) {
    ...
    .filter(hero => {console.log(`${hero.hero_project} ${project}`);return project === "-" ? true : hero.hero_project === project})
    ...
    return (
        ...
        <select value={project} onChange={(e)=> {console.log(e.target.value);setProject(e.target.value)}}>
            <option>-</option>
